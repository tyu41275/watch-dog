...
Status: **Approved plan — record only after the live path is stable**
Version: 1.0.0
Target duration: 2:40–2:50

## Three claims the video must prove
...
Keep narration near 330–375 words. Use stable defanged or reserved example domains and deterministic fixtures; never put a live malicious URL in the video.
